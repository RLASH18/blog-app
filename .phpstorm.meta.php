...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links.C:\Users\Lacdang\Herd\blog-app\public\storage' => 'string',
...
'filesystems.disks.s3.report','filesystems.links.C:\\Users\\Lacdang\\Herd\\blog-app\\public\\storage','logging.default','logging.deprecations.channel','logging.deprecations.trace',
...
'generated::cLNDT55VundUCEZH','login','generated::nerhcek0l3JtQLl3','register','generated::BbGyHHJQLShPv0l9',
'generated::LqBKhEdp2f7oFSQU','dashboard','posts.index','posts.create','posts.store',
'posts.show','posts.edit','posts.update','posts.destroy','storage.local',);
        registerArgumentsSet('views', 
'auth.login','auth.register','components.button-blue','components.button-red','components.card',
'components.form.button','components.form.error','components.form.form','components.form.input','components.form.label',
'components.layout-auth','components.layout-guest','components.message','components.sidebar','components.table.body',
'components.table.data','components.table.head','components.table.table','components.table.th','dashboard',
'posts.create','posts.edit','posts.index','posts.show','laravel-exceptions-renderer::components.card',
